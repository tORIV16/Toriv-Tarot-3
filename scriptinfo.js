...
const tarotCards = [
    // The Major Arcana
    {
        ...
        bridge: "Coming into this position, The Fool arrives light on his feet, ready to embrace whatever's next.",
        bridgeOut: "From here, The Fool's energy carries forward into the next card, still full of hope and momentum.",
        ...
        spreadFocus: "Your focus right now is on new beginnings — this is a moment to embrace the unknown and trust your instincts rather than needing every detail figured out.",
        spreadChallenge: "The challenge here is your own hesitation. It's easy to talk yourself out of something before you've truly given it a chance.",
        spreadAdvice: "Take the leap. You don't need the whole plan figured out before you begin, just the willingness to start.",
        spreadSuccess: "To follow through, keep a beginner's mind. Let curiosity lead more than fear of getting it wrong.",
        spreadMoveForward: "Moving forward, carry this openness with you. Staying true to this means continuing to choose courage over certainty, even after the excitement of starting wears off."
    },
    {
        card: 1,
        side: "B",
        ...
        bridge: "Coming into this position, The Fool reversed arrives a little unsteady, details slipping through the cracks.",
        bridgeOut: "From here, that carelessness carries forward unless it's named and corrected.",
        ...
        spreadFocus: "Your focus right now may be an area where you've been acting without enough thought, moving fast without checking the details.",
        spreadChallenge: "The challenge here is impulsiveness. Something important may be getting overlooked because it's more comfortable to rush ahead.",
        spreadAdvice: "Slow down and actually look at the details you've been skipping past. A little more care now prevents a bigger mess later.",
        spreadSuccess: "To follow through, build in a pause before you commit. Even five minutes of double-checking will serve you better than moving on instinct alone.",
        spreadMoveForward: "Moving forward, staying true to this means resisting the urge to rush the next decision too. Give yourself permission to go a little slower."
    },
    {
        card: 2,
        side: "A",
        ...
        bridgeOut: "From here, The Magician's focused energy carries forward, ready to be put to use.",
        ...
        spreadFocus: "Your focus right now is on your own capability — the tools and skills you already have, waiting to be used with intention.",
        spreadChallenge: "The challenge here is hesitation. You may be underestimating how ready you actually are to act.",
        spreadAdvice: "Stop waiting for permission or the perfect moment. Use what you have right now.",
        spreadSuccess: "To follow through, stay focused on one clear intention at a time rather than scattering your energy across everything at once.",
        spreadMoveForward: "Moving forward, keep checking that your actions match your intentions. Staying true to this means using your skill deliberately, not just impulsively."
    },
    {
        card: 2,
        side: "B",
        ...
        bridgeOut: "From here, that misdirected power carries forward unless the intention behind it is corrected.",
        ...
        spreadFocus: "Your focus right now may be an area where your talent or influence has drifted from its original purpose.",
        spreadChallenge: "The challenge here is misuse — using your ability in a way that serves ego or convenience over integrity.",
        spreadAdvice: "Pause and ask who actually benefits from what you're about to do before you act.",
        spreadSuccess: "To follow through, reconnect your actions to your actual values, not just what's easiest or most self-serving.",
        spreadMoveForward: "Moving forward, staying true to this means checking your intentions regularly, not just once."
    },
    {
        card: 3,
        side: "A",
        ...
        bridgeOut: "From here, The High Priestess's quiet wisdom carries forward into whatever comes next.",
        ...
        spreadFocus: "Your focus right now is on something that can't be rushed — an inner knowing that needs space to fully form.",
        spreadChallenge: "The challenge here is impatience. There's a temptation to force an answer before it's actually ready.",
        spreadAdvice: "Sit with the question a little longer. The clarity you want is close, but it isn't instant.",
        spreadSuccess: "To follow through, protect quiet time for reflection instead of filling every moment with noise or distraction.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to trust what you sense, even when you can't fully explain it yet."
    },
    {
        card: 3,
        side: "B",
        ...
        bridgeOut: "From here, that surface-level thinking carries forward unless you slow down and go deeper.",
        ...
        spreadFocus: "Your focus right now may be an area where you've been skimming the surface instead of truly listening inward.",
        spreadChallenge: "The challenge here is restlessness — rushing past your own intuition because sitting with it feels uncomfortable.",
        spreadAdvice: "Resist the urge to skim past this. The real answer is beneath the surface, not on top of it.",
        spreadSuccess: "To follow through, build in real quiet time before making any big decisions.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to check in with your deeper instincts instead of your first impulse."
    },
    {
        card: 4,
        side: "A",
        ...
        bridgeOut: "From here, The Empress's nurturing warmth carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on growth that comes through care, not force — nurturing something so it can flourish naturally.",
        spreadChallenge: "The challenge here is impatience with the pace of growth. Not everything blooms on your timeline.",
        spreadAdvice: "Give yourself the same care you'd give someone you love. Rest counts as productivity here.",
        spreadSuccess: "To follow through, keep tending to this gently and consistently rather than pushing for immediate results.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to nurture what you've started, and yourself along with it."
    },
    {
        card: 4,
        side: "B",
        ...
        bridgeOut: "From here, that imbalance carries forward unless something changes in how you give and receive.",
        ...
        spreadFocus: "Your focus right now may be an area where giving has become one-sided or depleting.",
        spreadChallenge: "The challenge here is neglecting your own needs while overextending for others, or the reverse.",
        spreadAdvice: "Check what you're giving away for free. It's okay to keep something for yourself.",
        spreadSuccess: "To follow through, set a clearer boundary around what you can realistically give without running yourself dry.",
        spreadMoveForward: "Moving forward, staying true to this means protecting your own capacity to nurture, not just everyone else's."
    },
    {
        card: 5,
        side: "A",
        ...
        bridgeOut: "From here, The Emperor's steady structure carries forward into the next step.",
        ...
        spreadFocus: "Your focus right now is on bringing order and structure to something that's felt unstable.",
        spreadChallenge: "The challenge here is following through with discipline once the initial motivation fades.",
        spreadAdvice: "Set the boundary you've been avoiding. Structure isn't the enemy of freedom here, it's what makes it possible.",
        spreadSuccess: "To follow through, build a clear, repeatable system instead of relying on willpower alone.",
        spreadMoveForward: "Moving forward, staying true to this means maintaining the structure even after the excitement of starting it wears off."
    },
    {
        card: 5,
        side: "B",
        ...
        bridgeOut: "From here, that rigidity carries forward unless you loosen your grip.",
        ...
        spreadFocus: "Your focus right now may be an area where control has tipped into rigidity or excess.",
        spreadChallenge: "The challenge here is stubbornness — holding onto how things 'should' go instead of adapting.",
        spreadAdvice: "Notice if you're gripping too tightly. Some flexibility now will save you a fight later.",
        spreadSuccess: "To follow through, practice loosening your grip on the small things so it's easier when it matters most.",
        spreadMoveForward: "Moving forward, staying true to this means leading with structure that bends, not one that breaks."
    },
    {
        card: 6,
        side: "A",
        ...
        bridgeOut: "From here, The Hierophant's grounded wisdom carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on learning from tradition, mentorship, or structure that's already proven itself.",
        spreadChallenge: "The challenge here is wanting to figure this out entirely on your own when guidance is available.",
        spreadAdvice: "Ask someone with more experience than you. This isn't the moment to reinvent the wheel alone.",
        spreadSuccess: "To follow through, stay open to feedback even when it challenges your own instincts.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to learn from those who've walked this path, without losing your own voice in the process."
    },
    {
        card: 6,
        side: "B",
        ...
        bridgeOut: "From here, that rigid thinking carries forward unless you question it.",
        ...
        spreadFocus: "Your focus right now may be an area where you've been following rules that no longer serve you.",
        spreadChallenge: "The challenge here is dogma — following a 'right' way of doing things without checking if it actually fits your situation.",
        spreadAdvice: "It's okay to break from the 'right' way of doing this if it's not actually working for you.",
        spreadSuccess: "To follow through, trust your own judgment over inherited assumptions, even if that feels uncomfortable at first.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to question rules rather than following them out of habit."
    },
    {
        card: 7,
        side: "A",
        ...
        bridgeOut: "From here, The Lovers' honest connection carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on a relationship or choice built on genuine honesty and mutual respect.",
        spreadChallenge: "The challenge here is choosing what's comfortable over what's true.",
        spreadAdvice: "Say the honest thing instead of the comfortable thing. The relationship can hold it.",
        spreadSuccess: "To follow through, keep communicating openly, even when it's easier to stay quiet.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to choose honesty as a daily practice, not a one-time conversation."
    },
    {
        card: 7,
        side: "B",
        ...
        bridgeOut: "From here, that imbalance carries forward unless it's addressed directly.",
        ...
        spreadFocus: "Your focus right now may be an area where a choice or relationship has drifted from real alignment.",
        spreadChallenge: "The challenge here is convenience masquerading as connection.",
        spreadAdvice: "Slow down before you commit to this. Check if it's genuinely aligned, not just convenient.",
        spreadSuccess: "To follow through, get honest about what's actually driving this choice before moving further.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to check your motives rather than defaulting to what's easy."
    },
    {
        card: 8,
        side: "A",
        ...
        bridgeOut: "From here, The Chariot's momentum carries forward into the next push.",
        ...
        spreadFocus: "Your focus right now is on driving forward with focus and determination.",
        spreadChallenge: "The challenge here is staying disciplined when the obstacles pull your attention away from the goal.",
        spreadAdvice: "Keep your eyes on the goal, not the obstacles. You have more control here than it feels like.",
        spreadSuccess: "To follow through, keep your direction singular instead of letting competing priorities pull you apart.",
        spreadMoveForward: "Moving forward, staying true to this means maintaining the same discipline once the initial burst of motivation fades."
    },
    {
        card: 8,
        side: "B",
        ...
        bridgeOut: "From here, that scattered focus carries forward unless you regroup.",
        ...
        spreadFocus: "Your focus right now may be an area where momentum has stalled or direction has gotten muddled.",
        spreadChallenge: "The challenge here is fighting to move forward instead of pausing to reassess the direction.",
        spreadAdvice: "Stop and figure out what's actually pulling you off course before you spend more energy fighting it.",
        spreadSuccess: "To follow through, regroup before pushing again — clarity now saves wasted effort later.",
        spreadMoveForward: "Moving forward, staying true to this means checking your direction regularly instead of assuming momentum alone will get you there."
    },
    {
        card: 9,
        side: "A",
        ...
        bridgeOut: "From here, Strength's quiet resolve carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on meeting a hard thing with calm, steady courage rather than force.",
        spreadChallenge: "The challenge here is the instinct to fight harder instead of staying gentle and patient.",
        spreadAdvice: "You don't need to fight this head-on. Soft, steady persistence will get you further.",
        spreadSuccess: "To follow through, keep choosing calm over control, even when it feels slower.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to meet hard things with patience instead of aggression."
    },
    {
        card: 9,
        side: "B",
        ...
        bridgeOut: "From here, that doubt carries forward unless it's named and addressed.",
        ...
        spreadFocus: "Your focus right now may be an area where fear or insecurity is quietly running the show.",
        spreadChallenge: "The challenge here is avoidance — letting fear dictate your actions instead of standing firm.",
        spreadAdvice: "Notice where you're avoiding something out of fear rather than genuine disinterest, then take one small step toward it.",
        spreadSuccess: "To follow through, take that step even while the fear is still present. Courage doesn't require its absence.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to act despite the doubt, not waiting for it to disappear first."
    },
    {
        card: 10,
        side: "A",
        ...
        bridgeOut: "From here, The Hermit's quiet reflection carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on stepping back from the noise to find your own answers.",
        spreadChallenge: "The challenge here is the pressure to stay busy or social when solitude is actually what's needed.",
        spreadAdvice: "Give yourself permission to say no to plans today. The answer you need is inside, not out there.",
        spreadSuccess: "To follow through, protect real time alone instead of squeezing reflection into the margins of a busy schedule.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to trust your inner wisdom over outside noise."
    },
    {
        card: 10,
        side: "B",
        ...
        bridgeOut: "From here, that withdrawal carries forward unless connection is restored.",
        ...
        spreadFocus: "Your focus right now may be an area where solitude has tipped into isolation.",
        spreadChallenge: "The challenge here is confusing withdrawal with genuine introspection.",
        spreadAdvice: "Reach out to one person today, even briefly. You've earned rest, not disappearance.",
        spreadSuccess: "To follow through, balance alone time with real connection, rather than choosing one at the total expense of the other.",
        spreadMoveForward: "Moving forward, staying true to this means checking in with yourself honestly about whether you're resting or avoiding."
    },
    {
        card: 11,
        side: "A",
        ...
        bridgeOut: "From here, the Wheel of Fortune's momentum carries forward into whatever comes next.",
        ...
        spreadFocus: "Your focus right now is on staying open to change rather than resisting it.",
        spreadChallenge: "The challenge here is the urge to control an outcome that's genuinely outside your hands.",
        spreadAdvice: "Stay flexible. What looks like a setback might just be the wheel turning toward something better.",
        spreadSuccess: "To follow through, keep adapting as circumstances shift instead of clinging to how things were.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to trust the cycle, even during its harder turns."
    },
    {
        card: 11,
        side: "B",
        ...
        bridgeOut: "From here, that stuck feeling carries forward unless you stop resisting the current.",
        ...
        spreadFocus: "Your focus right now may be an area where you feel stuck in a repeating, frustrating pattern.",
        spreadChallenge: "The challenge here is fighting the cycle instead of working with it.",
        spreadAdvice: "Whatever cycle you're stuck in, resisting it is using up energy you could spend adapting instead.",
        spreadSuccess: "To follow through, look for the small adjustment you can make rather than waiting for the whole situation to change on its own.",
        spreadMoveForward: "Moving forward, staying true to this means trusting that the wheel keeps turning, even when progress feels invisible."
    },
    {
        card: 12,
        side: "A",
        ...
        bridgeOut: "From here, Justice's clarity carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on facing something honestly and acting with integrity.",
        spreadChallenge: "The challenge here is the discomfort of admitting your own part in the situation.",
        spreadAdvice: "Be honest about your part in this, even the uncomfortable bit. It's the fastest way through.",
        spreadSuccess: "To follow through, keep choosing fairness over convenience as the situation unfolds.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to hold yourself to the same standard you're asking of others."
    },
    {
        card: 12,
        side: "B",
        ...
        bridgeOut: "From here, that imbalance carries forward unless accountability is taken.",
        ...
        spreadFocus: "Your focus right now may be an area where something isn't being weighed fairly.",
        spreadChallenge: "The challenge here is avoiding accountability, either your own or someone else's.",
        spreadAdvice: "Something here isn't being weighed fairly, possibly by you. Take an honest second look.",
        spreadSuccess: "To follow through, gather the full picture before drawing conclusions or taking action.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to check your own bias, not just calling out others' unfairness."
    },
    {
        card: 13,
        side: "A",
        ...
        bridgeOut: "From here, The Hanged Man's stillness carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on pausing and shifting your perspective rather than forcing a solution.",
        spreadChallenge: "The challenge here is the discomfort of not acting when everything in you wants to push forward.",
        spreadAdvice: "Stop trying to force this forward. The answer will come once you stop pushing so hard for it.",
        spreadSuccess: "To follow through, stay in the pause even when it feels unproductive. It's doing more than it looks like.",
        spreadMoveForward: "Moving forward, staying true to this means trusting the timing of the answer, rather than rushing to force a resolution."
    },
    {
        card: 13,
        side: "B",
        ...
        bridgeOut: "From here, that resistance carries forward unless you loosen your hold.",
        ...
        spreadFocus: "Your focus right now may be an area where you're resisting a change that's already necessary.",
        spreadChallenge: "The challenge here is stubbornness disguised as patience.",
        spreadAdvice: "Name the thing you're holding onto out of stubbornness rather than necessity, then loosen your grip a little.",
        spreadSuccess: "To follow through, practice letting go of small things first, so the bigger release feels less overwhelming.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to release what no longer serves you, even when it's familiar."
    },
    {
        card: 14,
        side: "A",
        ...
        bridgeOut: "From here, Death's necessary transformation carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on letting something end so real renewal can begin.",
        spreadChallenge: "The challenge here is the instinct to hold onto what's already finished.",
        spreadAdvice: "Let the thing that's already over actually end. Holding on is costing you more than closing it would.",
        spreadSuccess: "To follow through, take the concrete step that makes the ending real, rather than letting it linger unofficially.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to make space for renewal instead of clinging to what's gone."
    },
    {
        card: 14,
        side: "B",
        ...
        bridgeOut: "From here, that resistance carries forward unless the fear behind it is named.",
        ...
        spreadFocus: "Your focus right now may be an area where an ending is being delayed out of fear.",
        spreadChallenge: "The challenge here is fear of what comes after the ending, not the ending itself.",
        spreadAdvice: "Name what you're afraid will happen if you let this end. It's usually smaller than the fear itself.",
        spreadSuccess: "To follow through, take one small step toward accepting the ending instead of waiting for it to stop hurting first.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to move through the discomfort rather than freezing in place."
    },
    {
        card: 15,
        side: "A",
        ...
        bridgeOut: "From here, Temperance's steady balance carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on finding harmony through patience rather than urgency.",
        spreadChallenge: "The challenge here is the temptation to rush a process that needs time.",
        spreadAdvice: "Don't rush this. Small, steady adjustments will get you further than one big leap.",
        spreadSuccess: "To follow through, keep making small, consistent adjustments rather than dramatic changes.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to choose the middle path over extremes."
    },
    {
        card: 15,
        side: "B",
        ...
        bridgeOut: "From here, that imbalance carries forward unless you simplify.",
        ...
        spreadFocus: "Your focus right now may be an area where you've lost your footing between competing priorities.",
        spreadChallenge: "The challenge here is trying to hold too many things steady at once.",
        spreadAdvice: "Pick one thing to focus on today instead of trying to hold all of them steady at once.",
        spreadSuccess: "To follow through, narrow your focus deliberately, even if it means setting something else aside temporarily.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to protect your balance rather than overcommitting again."
    },
    {
        card: 16,
        side: "A",
        ...
        bridgeOut: "From here, The Devil's uncomfortable honesty carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on an attachment or habit that's quietly limiting your freedom.",
        spreadChallenge: "The challenge here is admitting how much choice you actually have in this.",
        spreadAdvice: "Look honestly at the habit or attachment that's been running the show. You have more choice here than it feels like.",
        spreadSuccess: "To follow through, take one concrete step away from the pattern, even a small one.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to choose freedom over familiar chains, one decision at a time."
    },
    {
        card: 16,
        side: "B",
        ...
        bridgeOut: "From here, that breaking-free momentum carries forward as long as you keep going.",
        ...
        spreadFocus: "Your focus right now is on continuing to loosen the grip of an old pattern.",
        spreadChallenge: "The challenge here is the temptation to slide back into what's familiar and comfortable.",
        spreadAdvice: "Whatever progress you've made in letting go of this, keep going. Don't talk yourself back into the chains.",
        spreadSuccess: "To follow through, notice the moments you're tempted to backslide, and choose differently in them.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to walk away, even when it would be easier to turn back."
    },
    {
        card: 17,
        side: "A",
        ...
        bridgeOut: "From here, The Tower's disruption carries forward into whatever gets rebuilt.",
        ...
        spreadFocus: "Your focus right now is on something that needs to fall apart before it can be rebuilt honestly.",
        spreadChallenge: "The challenge here is the instinct to rebuild exactly what just collapsed.",
        spreadAdvice: "Don't rush to rebuild exactly what just collapsed. Take a moment to see what actually needs to exist here.",
        spreadSuccess: "To follow through, let the dust settle before making decisions about what comes next.",
        spreadMoveForward: "Moving forward, staying true to this means building something more honest this time, not just familiar."
    },
    {
        card: 17,
        side: "B",
        ...
        bridgeOut: "From here, that avoidance carries forward unless the pressure is faced directly.",
        ...
        spreadFocus: "Your focus right now may be an area where change is being delayed rather than faced.",
        spreadChallenge: "The challenge here is avoidance making the eventual shift more turbulent than it needs to be.",
        spreadAdvice: "Something here is going to change whether or not you're ready. Better to loosen your grip now on your own terms.",
        spreadSuccess: "To follow through, take the first step toward the change on your own terms, before it's forced on you.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to face change directly rather than bracing against it."
    },
    {
        card: 18,
        side: "A",
        ...
        bridgeOut: "From here, The Star's quiet hope carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on healing and letting hope return after a hard stretch.",
        spreadChallenge: "The challenge here is trusting that things are actually getting better when progress feels slow.",
        spreadAdvice: "Let yourself believe things can get better. That hope isn't naive, it's earned.",
        spreadSuccess: "To follow through, keep noticing the small signs of healing instead of only measuring the distance left to go.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to nurture hope even when it feels fragile."
    },
    {
        card: 18,
        side: "B",
        ...
        bridgeOut: "From here, that discouragement carries forward unless hope is reconnected with.",
        ...
        spreadFocus: "Your focus right now may be an area where doubt has dimmed your hope.",
        spreadChallenge: "The challenge here is letting temporary discouragement feel like a permanent verdict.",
        spreadAdvice: "You don't have to feel hopeful today to keep going. Just don't let the doubt make permanent decisions.",
        spreadSuccess: "To follow through, keep moving forward in small ways even while the hope hasn't fully returned yet.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to reconnect with what still feels possible."
    },
    {
        card: 19,
        side: "A",
        ...
        bridgeOut: "From here, The Moon's uncertainty carries forward until clarity settles.",
        ...
        spreadFocus: "Your focus right now is on trusting your intuition through something that isn't fully clear yet.",
        spreadChallenge: "The challenge here is wanting certainty before it's actually available.",
        spreadAdvice: "Don't make a big decision on unclear information today. Give it another day or two to come into focus.",
        spreadSuccess: "To follow through, keep trusting your gut over the surface-level story until real clarity arrives.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to move carefully through ambiguity rather than forcing false certainty."
    },
    {
        card: 19,
        side: "B",
        ...
        bridgeOut: "From here, that returning clarity carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on trusting the clarity that's beginning to return after confusion.",
        spreadChallenge: "The challenge here is doubting the clarity because it feels new or fragile.",
        spreadAdvice: "Trust the clarity that's returning, even if it's not complete yet. You're seeing more accurately now.",
        spreadSuccess: "To follow through, act on what's becoming clear instead of second-guessing it back into confusion.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to trust your improving perspective."
    },
    {
        card: 20,
        side: "A",
        ...
        bridgeOut: "From here, The Sun's warmth carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on letting joy and confidence lead without waiting for the other shoe to drop.",
        spreadChallenge: "The challenge here is the instinct to brace for something to go wrong.",
        spreadAdvice: "Let yourself enjoy this without waiting for the other shoe to drop. You've earned it.",
        spreadSuccess: "To follow through, keep sharing this joy openly instead of downplaying it.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to let good things simply feel good."
    },
    {
        card: 20,
        side: "B",
        ...
        bridgeOut: "From here, that clouded feeling carries forward until the light is found again.",
        ...
        spreadFocus: "Your focus right now may be an area where your usual confidence or joy feels dimmed.",
        spreadChallenge: "The challenge here is mistaking a temporary low for a permanent state.",
        spreadAdvice: "The good things haven't disappeared, they're just harder to see right now. Look for one small bright spot today.",
        spreadSuccess: "To follow through, actively look for small wins instead of waiting for a big shift in mood.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to seek the light, even in small doses."
    },
    {
        card: 21,
        side: "A",
        ...
        bridgeOut: "From here, Judgement's call carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on answering a call you've been putting off.",
        spreadChallenge: "The challenge here is the fear that makes the call feel scarier than it actually is.",
        spreadAdvice: "Answer the call you've been putting off. It's not as scary as the waiting has made it feel.",
        spreadSuccess: "To follow through, take the concrete first step toward answering it, rather than continuing to circle it.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to step into what you're being called toward, not backing away from it."
    },
    {
        card: 21,
        side: "B",
        ...
        bridgeOut: "From here, that guilt carries forward unless met with compassion.",
        ...
        spreadFocus: "Your focus right now may be an area where self-doubt or guilt is holding you back.",
        spreadChallenge: "The challenge here is being harder on yourself than the situation actually calls for.",
        spreadAdvice: "Whatever you're being hard on yourself about, it's time to let it go. You don't have to earn forgiveness from yourself.",
        spreadSuccess: "To follow through, practice speaking to yourself the way you would to someone you love.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to release self-judgment as it resurfaces."
    },
    {
        card: 22,
        side: "A",
        ...
        bridgeOut: "From here, The World's sense of completion carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on acknowledging something that's genuinely finished before moving to what's next.",
        spreadChallenge: "The challenge here is rushing past the completion without letting yourself feel it.",
        spreadAdvice: "Take a real moment to acknowledge what you've finished before jumping into the next thing.",
        spreadSuccess: "To follow through, mark the completion in some concrete way, even a small one.",
        spreadMoveForward: "Moving forward, staying true to this means carrying this sense of wholeness into whatever chapter comes next."
    },
    {
        card: 22,
        side: "B",
        ...
        bridgeOut: "From here, that unfinished feeling carries forward until it's addressed.",
        ...
        spreadFocus: "Your focus right now may be an area that feels almost done but isn't quite finished.",
        spreadChallenge: "The challenge here is the urge to start something new before properly closing this one out.",
        spreadAdvice: "Identify the one loose end that's actually keeping this from feeling finished, and tie it off.",
        spreadSuccess: "To follow through, resist starting something new until this one is genuinely closed.",
        spreadMoveForward: "Moving forward, staying true to this means finishing what you start before reaching for the next thing."
    },
        ...
        // Wands
    {
        ...
        bridgeOut: "From here, the spark of the Ace of Wands carries forward into real momentum.",
        ...
        spreadFocus: "Your focus right now is on a fresh burst of inspiration that's ready to be acted on.",
        spreadChallenge: "The challenge here is following through before the spark fades.",
        spreadAdvice: "Write the idea down before you lose it, then take one real step toward it today.",
        spreadSuccess: "To follow through, protect the early momentum by giving it consistent attention, not just excitement.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to act on inspiration instead of letting it sit unused."
    },
    {
        card: 23,
        side: "B",
        ...
        bridgeOut: "From here, that stalled spark carries forward unless it's reignited.",
        ...
        spreadFocus: "Your focus right now may be an area where creative energy has fizzled or gone unused.",
        spreadChallenge: "The challenge here is forcing enthusiasm that genuinely isn't there yet.",
        spreadAdvice: "If the excitement isn't there, don't force it today. Revisit the idea when it feels alive again.",
        spreadSuccess: "To follow through, give yourself permission to rest instead of pushing through low motivation.",
        spreadMoveForward: "Moving forward, staying true to this means waiting for genuine spark rather than manufacturing false urgency."
    },
    {
        card: 24,
        side: "A",
        ...
        bridgeOut: "From here, the Two of Wands' ambition carries forward into a real decision.",
        ...
        spreadFocus: "Your focus right now is on a decision that could expand your world if you're willing to choose.",
        spreadChallenge: "The challenge here is staying stuck in planning instead of committing to an option.",
        spreadAdvice: "Stop planning in your head and put one real option on the table today.",
        spreadSuccess: "To follow through, pick a direction and take one concrete action toward it.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to expand rather than retreating to what's familiar."
    },
    {
        card: 24,
        side: "B",
        ...
        bridgeOut: "From here, that hesitation carries forward unless the fear is named.",
        ...
        spreadFocus: "Your focus right now may be an area where fear of the unknown is stalling your progress.",
        spreadChallenge: "The challenge here is letting doubt make the decision by default.",
        spreadAdvice: "Name the worst-case scenario out loud. It usually shrinks once you actually look at it.",
        spreadSuccess: "To follow through, take one small step even while the fear is still present.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to choose action over avoidance."
    },
    {
        card: 25,
        side: "A",
        ...
        bridgeOut: "From here, the Three of Wands' momentum carries forward as the plan unfolds.",
        ...
        spreadFocus: "Your focus right now is on trusting the groundwork you've already laid.",
        spreadChallenge: "The challenge here is impatience with a plan that's still unfolding.",
        spreadAdvice: "Trust the plan you already set in motion. You don't need to start over, just keep watching it unfold.",
        spreadSuccess: "To follow through, keep monitoring progress without micromanaging or restarting prematurely.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to trust the long view you've already committed to."
    },
    {
        card: 25,
        side: "B",
        ...
        bridgeOut: "From here, that delay carries forward unless the approach is adjusted.",
        ...
        spreadFocus: "Your focus right now may be an area where progress has stalled short of the goal.",
        spreadChallenge: "The challenge here is mistaking delay for failure.",
        spreadAdvice: "A delay isn't a failure. Tweak your approach and give it more time before deciding it's not working.",
        spreadSuccess: "To follow through, make one small adjustment rather than abandoning the plan entirely.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to adapt instead of giving up."
    },
    {
        card: 26,
        side: "A",
        ...
        bridgeOut: "From here, the Four of Wands' celebration carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on pausing to actually celebrate something you've earned.",
        spreadChallenge: "The challenge here is rushing past the good moment to get to the next task.",
        spreadAdvice: "Actually celebrate this instead of rushing to the next task. You've earned a pause.",
        spreadSuccess: "To follow through, mark this moment in some real way instead of letting it pass unnoticed.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to make space for joy along the way, not just at the end."
    },
    {
        card: 26,
        side: "B",
        ...
        bridgeOut: "From here, that unsettled feeling carries forward until it's addressed.",
        ...
        spreadFocus: "Your focus right now may be an area of instability at home or within a group.",
        spreadChallenge: "The challenge here is trying to force harmony before the underlying issue is resolved.",
        spreadAdvice: "Address the thing that's unsettled before trying to force a good mood around it.",
        spreadSuccess: "To follow through, name what's actually unsettled rather than papering over it.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to prioritize real stability over surface harmony."
    },
    {
        card: 27,
        side: "A",
        ...
        bridgeOut: "From here, the Five of Wands' friction carries forward unless it's kept in perspective.",
        ...
        spreadFocus: "Your focus right now is on navigating some competition or friction without taking it too personally.",
        spreadChallenge: "The challenge here is mistaking noise for a real threat.",
        spreadAdvice: "Don't take every disagreement personally today. Some of this is just posturing, not a real fight.",
        spreadSuccess: "To follow through, stay grounded and pick your battles rather than reacting to every friction point.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to hold your ground without escalating unnecessarily."
    },
    {
        card: 27,
        side: "B",
        ...
        bridgeOut: "From here, that hidden tension carries forward unless it's brought into the open.",
        ...
        spreadFocus: "Your focus right now may be an area with dishonesty or indirect conflict beneath the surface.",
        spreadChallenge: "The challenge here is trusting your instinct that something feels off.",
        spreadAdvice: "If something feels off about how someone's dealing with you, trust that instinct and get things in writing.",
        spreadSuccess: "To follow through, document things clearly and stay alert rather than assuming good faith blindly.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to protect yourself with clarity, not just hope."
    },
    {
        card: 28,
        side: "A",
        ...
        bridgeOut: "From here, the Six of Wands' recognition carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on accepting recognition for effort you've genuinely earned.",
        spreadChallenge: "The challenge here is deflecting praise instead of receiving it.",
        spreadAdvice: "Let people acknowledge what you did. You don't have to deflect the compliment today.",
        spreadSuccess: "To follow through, accept the recognition graciously instead of minimizing your role.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to own your accomplishments without over-explaining them."
    },
    {
        card: 28,
        side: "B",
        ...
        bridgeOut: "From here, that self-doubt carries forward unless it's addressed.",
        ...
        spreadFocus: "Your focus right now may be an area where your effort feels unacknowledged.",
        spreadChallenge: "The challenge here is measuring your worth by outside applause.",
        spreadAdvice: "The lack of recognition doesn't mean the effort didn't count. Keep going regardless of who's watching.",
        spreadSuccess: "To follow through, keep your own internal standard of success front and center.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to trust your own judgment of your progress."
    },
    {
        card: 29,
        side: "A",
        ...
        bridgeOut: "From here, the Seven of Wands' resolve carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on defending a position that's genuinely worth holding.",
        spreadChallenge: "The challenge here is doubting whether you have the right to hold your ground.",
        spreadAdvice: "Stand your ground on this one. You have the higher position even if it doesn't feel like it.",
        spreadSuccess: "To follow through, keep defending your position calmly rather than over-explaining or apologizing for it.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to hold your boundary even under pressure."
    },
    {
        card: 29,
        side: "B",
        ...
        bridgeOut: "From here, that shaken confidence carries forward until you regroup.",
        ...
        spreadFocus: "Your focus right now may be an area where you feel outnumbered or unsure of your footing.",
        spreadChallenge: "The challenge here is trying to defend everything at once instead of choosing what matters most.",
        spreadAdvice: "It's okay to step back and reassess instead of fighting every battle at once today.",
        spreadSuccess: "To follow through, pick the one front that actually matters and let the others go for now.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to choose your battles deliberately."
    },
    {
        card: 30,
        side: "A",
        ...
        bridgeOut: "From here, the Eight of Wands' speed carries forward fast.",
        ...
        spreadFocus: "Your focus right now is on staying ready as things pick up pace quickly.",
        spreadChallenge: "The challenge here is getting caught off guard by how fast things move.",
        spreadAdvice: "Get ready to move quickly. Have what you need on hand so you're not caught off guard by the pace.",
        spreadSuccess: "To follow through, stay prepared and responsive rather than reactive.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to move quickly without losing your footing."
    },
    {
        card: 30,
        side: "B",
        ...
        bridgeOut: "From here, that delay carries forward until patience wins out.",
        ...
        spreadFocus: "Your focus right now may be an area slowed by frustration or miscommunication.",
        spreadChallenge: "The challenge here is letting impatience make things worse.",
        spreadAdvice: "The delay isn't permanent. Use the wait productively instead of stewing in the frustration.",
        spreadSuccess: "To follow through, double-check communication instead of assuming the worst about the holdup.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to stay patient through unavoidable delays."
    },
    {
        card: 31,
        side: "A",
        ...
        bridgeOut: "From here, the Nine of Wands' resilience carries forward into the final stretch.",
        ...
        spreadFocus: "Your focus right now is on pushing through the last stretch, even while tired.",
        spreadChallenge: "The challenge here is wanting to quit right before the finish.",
        spreadAdvice: "You're closer to the finish than it feels. Don't quit on the second-to-last stretch.",
        spreadSuccess: "To follow through, draw on the resilience you've already proven you have.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to push through, even when it's uncomfortable."
    },
    {
        card: 31,
        side: "B",
        ...
        bridgeOut: "From here, that exhaustion carries forward until real rest is taken.",
        ...
        spreadFocus: "Your focus right now may be an area where you're running on empty.",
        spreadChallenge: "The challenge here is pushing through when rest is actually what's needed.",
        spreadAdvice: "This is a sign to actually rest, not push through. Recovery isn't the same as giving up.",
        spreadSuccess: "To follow through, allow yourself real recovery time instead of powering through depleted.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to prioritize sustainable pace over forced endurance."
    },
    {
        card: 32,
        side: "A",
        ...
        bridgeOut: "From here, the Ten of Wands' weight carries forward unless something is set down.",
        ...
        spreadFocus: "Your focus right now is on carrying more than was ever meant for one set of hands.",
        spreadChallenge: "The challenge here is refusing to ask for help or delegate.",
        spreadAdvice: "You don't have to carry all of this alone. Delegate or drop one thing today.",
        spreadSuccess: "To follow through, actually hand off or release one responsibility, not just think about it.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to check your load before adding more to it."
    },
    {
        card: 32,
        side: "B",
        ...
        bridgeOut: "From here, that burnout carries forward unless something is released.",
        ...
        spreadFocus: "Your focus right now may be an area where the weight has become unsustainable.",
        spreadChallenge: "The challenge here is enduring instead of actually lightening the load.",
        spreadAdvice: "Something on your plate needs to go, not just be tolerated. Choose what to release today.",
        spreadSuccess: "To follow through, make the release concrete rather than just wishing things were lighter.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to protect your capacity instead of overloading it again."
    },
    {
        card: 33,
        side: "A",
        ...
        bridgeOut: "From here, the Page of Wands' curiosity carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on following genuine excitement, even if the plan isn't fully formed.",
        spreadChallenge: "The challenge here is talking yourself out of something just because it's unpolished.",
        spreadAdvice: "Say yes to the thing that sounds fun, even if it's not fully thought out yet.",
        spreadSuccess: "To follow through, let curiosity lead the first steps instead of demanding a full plan upfront.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to chase what excites you, not just what's safe."
    },
    {
        card: 33,
        side: "B",
        ...
        bridgeOut: "From here, that scattered energy carries forward until it's focused.",
        ...
        spreadFocus: "Your focus right now may be an area where enthusiasm has spread too thin.",
        spreadChallenge: "The challenge here is chasing the next new thing before finishing the current one.",
        spreadAdvice: "Pick one of the ideas you've been bouncing between and actually finish it before starting another.",
        spreadSuccess: "To follow through, commit to completing one thing before allowing yourself to start something new.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to follow through, not just start."
    },
    {
        card: 34,
        side: "A",
        ...
        bridgeOut: "From here, the Knight of Wands' bold charge carries forward into the leap.",
        ...
        spreadFocus: "Your focus right now is on taking bold action, even without every detail figured out.",
        spreadChallenge: "The challenge here is skipping preparation in the rush to move.",
        spreadAdvice: "Go for it, but pack a little more preparation than usual, this energy tends to skip steps.",
        spreadSuccess: "To follow through, balance boldness with just enough preparation to avoid unnecessary mistakes.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to move boldly while staying a little more grounded."
    },
    {
        card: 34,
        side: "B",
        ...
        bridgeOut: "From here, that recklessness carries forward unless the pace slows.",
        ...
        spreadFocus: "Your focus right now may be an area where impulsiveness is creating friction.",
        spreadChallenge: "The challenge here is acting faster than your judgment can keep up with.",
        spreadAdvice: "Take a breath before you send that message or make that call. The urgency might be bigger in your head than in reality.",
        spreadSuccess: "To follow through, build in a pause before reacting, even a short one.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to slow down enough to check your impulses."
    },
    {
        card: 35,
        side: "A",
        ...
        bridgeOut: "From here, the Queen of Wands' confidence carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on leading with natural warmth and confidence.",
        spreadChallenge: "The challenge here is holding back your presence out of self-doubt.",
        spreadAdvice: "Lead with your natural confidence today, even in the small interactions. People respond to it more than you think.",
        spreadSuccess: "To follow through, keep showing up fully instead of shrinking to fit the room.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to trust your own magnetic energy."
    },
    {
        card: 35,
        side: "B",
        ...
        bridgeOut: "From here, that insecurity carries forward unless it's named.",
        ...
        spreadFocus: "Your focus right now may be an area where jealousy or opposition is clouding your judgment.",
        spreadChallenge: "The challenge here is competing out of insecurity rather than real conflict.",
        spreadAdvice: "Check whether you're competing with someone out of insecurity rather than real conflict.",
        spreadSuccess: "To follow through, redirect that energy toward your own goals instead of comparison.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to stay grounded in your own light, not measured against someone else's."
    },
    {
        card: 36,
        side: "A",
        ...
        bridgeOut: "From here, the King of Wands' vision carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on leading with vision others are ready to follow.",
        spreadChallenge: "The challenge here is keeping the big idea to yourself out of hesitation.",
        spreadAdvice: "Share the big idea out loud today instead of keeping it to yourself. People are ready to hear it.",
        spreadSuccess: "To follow through, keep communicating the vision clearly and confidently as you move forward.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to lead boldly without losing sight of the people following you."
    },
    {
        card: 36,
        side: "B",
        ...
        bridgeOut: "From here, that harshness carries forward unless tempered with listening.",
        ...
        spreadFocus: "Your focus right now may be an area where leadership has tipped into control or impatience.",
        spreadChallenge: "The challenge here is pushing your point instead of hearing the other side.",
        spreadAdvice: "Before you push your point again today, take a moment to actually hear the other side.",
        spreadSuccess: "To follow through, practice listening as intentionally as you practice leading.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to lead with humility alongside vision."
    },
        ...
        // Cups
    {
        ...
        bridgeOut: "From here, the Ace of Cups' open heart carries forward into whatever it touches next.",
        ...
        spreadFocus: "Your focus right now is on staying emotionally open to something new.",
        spreadChallenge: "The challenge here is guarding against the vulnerability that comes with real openness.",
        spreadAdvice: "Let yourself feel this fully instead of guarding against it. The openness is safe right now.",
        spreadSuccess: "To follow through, keep choosing openness even when the instinct is to protect yourself.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to let your heart lead without over-guarding it."
    },
    {
        card: 37,
        side: "B",
        ...
        bridgeOut: "From here, that unsteady opening carries forward until real trust is restored.",
        ...
        spreadFocus: "Your focus right now may be an area where your emotional footing feels shaky or uncertain.",
        spreadChallenge: "The challenge here is performing openness rather than actually feeling it.",
        spreadAdvice: "Notice if you're performing an emotion rather than actually feeling it today.",
        spreadSuccess: "To follow through, get honest with yourself about what you actually feel before presenting it outwardly.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to check that your feelings and your actions actually match."
    },
    {
        card: 38,
        side: "A",
        ...
        bridgeOut: "From here, the Two of Cups' mutual respect carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on a connection built on genuine mutual respect.",
        spreadChallenge: "The challenge here is taking the connection for granted instead of nurturing it.",
        spreadAdvice: "Say thank you to the person who's been showing up for you lately. Reciprocity deserves to be spoken out loud.",
        spreadSuccess: "To follow through, keep showing up for this relationship the way they've shown up for you.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to treat the connection as a mutual exchange, not a given."
    },
    {
        card: 38,
        side: "B",
        ...
        bridgeOut: "From here, that misunderstanding carries forward unless it's addressed.",
        ...
        spreadFocus: "Your focus right now may be an area where miscommunication has caused disconnection.",
        spreadChallenge: "The challenge here is letting the misunderstanding sit unspoken.",
        spreadAdvice: "Clear up the misunderstanding directly instead of letting it sit and grow bigger than it needs to be.",
        spreadSuccess: "To follow through, have the direct conversation instead of assuming what the other person meant.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to check in rather than assume."
    },
    {
        card: 39,
        side: "A",
        ...
        bridgeOut: "From here, the Three of Cups' shared joy carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on sharing good news and celebration with people who matter.",
        spreadChallenge: "The challenge here is keeping the joy to yourself instead of inviting others in.",
        spreadAdvice: "Call the friend who'd want to celebrate this with you. Don't keep the good news to yourself.",
        spreadSuccess: "To follow through, keep making space for connection alongside the celebration.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to share your wins, not just carry them alone."
    },
    {
        card: 39,
        side: "B",
        ...
        bridgeOut: "From here, that letdown carries forward unless your energy is redirected.",
        ...
        spreadFocus: "Your focus right now may be an area where a friendship or group has let you down.",
        spreadChallenge: "The challenge here is staying loyal to connections that aren't reciprocated.",
        spreadAdvice: "Notice which friendships feel one-sided right now, and give your energy to the ones that don't.",
        spreadSuccess: "To follow through, redirect your energy toward the relationships that actually show up for you.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to protect your energy for connections that give back."
    },
    {
        card: 40,
        side: "A",
        ...
        bridgeOut: "From here, the Four of Cups' quiet discontent carries forward until it's named.",
        ...
        spreadFocus: "Your focus right now is on noticing what's genuinely missing instead of staying numb to it.",
        spreadChallenge: "The challenge here is staying so lost in your own thoughts that you miss what's being offered.",
        spreadAdvice: "Look up. There may be an offer or opportunity in front of you that you're too distracted to notice.",
        spreadSuccess: "To follow through, stay open to the offer even if it doesn't match what you were expecting.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to look up and outward, not just inward."
    },
    {
        card: 40,
        side: "B",
        ...
        bridgeOut: "From here, that renewed interest carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on following the spark of curiosity that's returning.",
        spreadChallenge: "The challenge here is talking yourself out of re-engaging just because you've been checked out.",
        spreadAdvice: "Take the invitation you've been about to decline. Your motivation is coming back.",
        spreadSuccess: "To follow through, act on the renewed interest before the old apathy creeps back in.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to follow what's sparking your curiosity again."
    },
    {
        card: 41,
        side: "A",
        ...
        bridgeOut: "From here, the Five of Cups' grief carries forward until the two standing cups are seen.",
        ...
        spreadFocus: "Your focus right now is on honoring a real loss without losing sight of what remains.",
        spreadChallenge: "The challenge here is letting grief eclipse everything else that's still good.",
        spreadAdvice: "Let yourself grieve fully today, but try to notice the two cups still standing before the day ends.",
        spreadSuccess: "To follow through, hold both the grief and the gratitude at the same time, rather than choosing one.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to make room for both loss and what remains."
    },
    {
        card: 41,
        side: "B",
        ...
        bridgeOut: "From here, that returning hope carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on trusting the hope that's beginning to return.",
        spreadChallenge: "The challenge here is doubting the hope because it feels early or fragile.",
        spreadAdvice: "Let yourself feel a little hope today, even if it feels premature. It isn't.",
        spreadSuccess: "To follow through, keep nurturing the hope with small, real actions rather than just waiting for it to grow on its own.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to trust the healing that's underway."
    },
    {
        card: 42,
        side: "A",
        ...
        bridgeOut: "From here, the Six of Cups' warmth carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on drawing comfort from something familiar and gentle.",
        spreadChallenge: "The challenge here is staying stuck in nostalgia instead of using it as a resource.",
        spreadAdvice: "Reach out to someone from your past today, or revisit something that used to bring you comfort.",
        spreadSuccess: "To follow through, let the comfort of the past inform the present without replacing it.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to draw on warmth from your history while still living forward."
    },
    {
        card: 42,
        side: "B",
        ...
        bridgeOut: "From here, that avoidance carries forward unless it's named.",
        ...
        spreadFocus: "Your focus right now may be an area where nostalgia has become a way of avoiding the present.",
        spreadChallenge: "The challenge here is romanticizing the past instead of facing what's happening now.",
        spreadAdvice: "Notice if you're romanticizing the past to avoid dealing with something in the present.",
        spreadSuccess: "To follow through, name what you're actually avoiding by staying in the past.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to face the present honestly instead of retreating to memory."
    },
    {
        card: 43,
        side: "A",
        ...
        bridgeOut: "From here, the Seven of Cups' many options carry forward until one is chosen.",
        ...
        spreadFocus: "Your focus right now is on narrowing down real options from tempting fantasies.",
        spreadChallenge: "The challenge here is getting lost in possibility instead of committing to one path.",
        spreadAdvice: "Pick one option and actually investigate it today instead of daydreaming about all of them at once.",
        spreadSuccess: "To follow through, take one concrete action on the option you chose instead of circling back to the others.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to follow through on the choice rather than second-guessing it."
    },
    {
        card: 43,
        side: "B",
        ...
        bridgeOut: "From here, that clarity carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on trusting the option that's finally become clear.",
        spreadChallenge: "The challenge here is second-guessing a decision that's actually already been made.",
        spreadAdvice: "Trust the option that's become obvious. You've done enough deliberating.",
        spreadSuccess: "To follow through, act on the clarity instead of reopening the decision.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to trust your own resolved choice."
    },
    {
        card: 44,
        side: "A",
        ...
        bridgeOut: "From here, the Eight of Cups' quiet departure carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on walking away from something that no longer serves your growth.",
        spreadChallenge: "The challenge here is guilt over leaving something that looks fine from the outside.",
        spreadAdvice: "Give yourself permission to walk away from this, even if it looks fine from the outside.",
        spreadSuccess: "To follow through, keep moving forward instead of looking back to justify the decision.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to trust that leaving was the right call."
    },
    {
        card: 44,
        side: "B",
        ...
        bridgeOut: "From here, that stuck feeling carries forward unless what's keeping you is named.",
        ...
        spreadFocus: "Your focus right now may be an area where you're emotionally entangled and struggling to let go.",
        spreadChallenge: "The challenge here is fear of the unknown keeping you tied to something you've already outgrown.",
        spreadAdvice: "Name what's actually keeping you tied to this. Fear of the unknown is a real reason, but it's not a good enough one.",
        spreadSuccess: "To follow through, take the concrete step of actually finishing the walk away.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to release the ties that are holding you back."
    },
    {
        card: 45,
        side: "A",
        ...
        bridgeOut: "From here, the Nine of Cups' contentment carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on enjoying genuine satisfaction without needing to justify it.",
        spreadChallenge: "The challenge here is immediately wondering what's next instead of sitting with what's good.",
        spreadAdvice: "Enjoy this without immediately wondering what's next. You're allowed to just be satisfied.",
        spreadSuccess: "To follow through, keep resisting the urge to chase more before appreciating what you have.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to let contentment be enough on its own."
    },
    {
        card: 45,
        side: "B",
        ...
        bridgeOut: "From here, that small letdown carries forward until the expectation is adjusted.",
        ...
        spreadFocus: "Your focus right now may be an area where things didn't quite live up to expectation.",
        spreadChallenge: "The challenge here is measuring satisfaction against a standard that isn't really yours.",
        spreadAdvice: "Check whether the goal you're chasing is actually yours, or something you picked up from someone else.",
        spreadSuccess: "To follow through, redefine what success actually looks like for you specifically.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to measure fulfillment by your own standard."
    },
    {
        card: 46,
        side: "A",
        ...
        bridgeOut: "From here, the Ten of Cups' harmony carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on protecting a deep sense of peace and emotional richness.",
        spreadChallenge: "The challenge here is letting this happiness go unnoticed amid the busyness of daily life.",
        spreadAdvice: "Take a moment to actually notice this happiness instead of letting it pass by unnoticed.",
        spreadSuccess: "To follow through, keep being fully present with the people and moments that matter most.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to protect this peace deliberately."
    },
    {
        card: 46,
        side: "B",
        ...
        bridgeOut: "From here, that unspoken tension carries forward until it's addressed.",
        ...
        spreadFocus: "Your focus right now may be an area of friction within a close relationship or family.",
        spreadChallenge: "The challenge here is pretending everything's fine for the sake of surface harmony.",
        spreadAdvice: "Address the tension directly instead of pretending everything's fine for the sake of harmony.",
        spreadSuccess: "To follow through, have the honest conversation instead of avoiding it further.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to prioritize real peace over performed harmony."
    },
    {
        card: 47,
        side: "A",
        ...
        bridgeOut: "From here, the Page of Cups' small spark carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on noticing a small, surprising feeling worth paying attention to.",
        spreadChallenge: "The challenge here is dismissing the feeling because it seems too small to matter.",
        spreadAdvice: "Pay attention to the unexpected feeling or idea that showed up today. It's worth more than it seems.",
        spreadSuccess: "To follow through, follow the feeling even without knowing exactly where it leads.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to trust small emotional cues as real information."
    },
    {
        card: 47,
        side: "B",
        ...
        bridgeOut: "From here, that missed cue carries forward until you slow down enough to notice it.",
        ...
        spreadFocus: "Your focus right now may be an area where an emotional signal is easy to miss.",
        spreadChallenge: "The challenge here is moving too fast to notice what you're actually feeling.",
        spreadAdvice: "Slow down enough today to actually notice how you're feeling, instead of rushing past it.",
        spreadSuccess: "To follow through, build in small pauses to check in with yourself throughout the day.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to stay present with your own emotional state."
    },
    {
        card: 48,
        side: "A",
        ...
        bridgeOut: "From here, the Knight of Cups' gentle invitation carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on accepting a genuine, heartfelt invitation.",
        spreadChallenge: "The challenge here is talking yourself out of something good because it feels too idealistic.",
        spreadAdvice: "Say yes to the romantic or creative invitation in front of you. It's coming from a genuine place.",
        spreadSuccess: "To follow through, keep showing up for this with the same openness it was offered.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to follow your heart's genuine invitations."
    },
    {
        card: 48,
        side: "B",
        ...
        bridgeOut: "From here, that unsteady offer carries forward until it's looked at more closely.",
        ...
        spreadFocus: "Your focus right now may be an area where charm is outpacing substance.",
        spreadChallenge: "The challenge here is wanting to believe the promise more than checking if it's real.",
        spreadAdvice: "Notice if the words match the actions here. Charm alone isn't proof of sincerity.",
        spreadSuccess: "To follow through, watch for consistency between what's said and what's actually done.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to trust actions over words."
    },
    {
        card: 49,
        side: "A",
        ...
        bridgeOut: "From here, the Queen of Cups' compassion carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on holding space for feelings without rushing to fix them.",
        spreadChallenge: "The challenge here is over-giving to the point of losing your own emotional footing.",
        spreadAdvice: "Offer someone your full presence today rather than advice. That's what they actually need.",
        spreadSuccess: "To follow through, keep offering presence while still protecting your own emotional reserves.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to lead with empathy without losing yourself in it."
    },
    {
        card: 49,
        side: "B",
        ...
        bridgeOut: "From here, that emotional distance carries forward unless you reconnect.",
        ...
        spreadFocus: "Your focus right now may be an area where you've turned inward and become less available to others.",
        spreadChallenge: "The challenge here is mistaking self-focus for self-care.",
        spreadAdvice: "Check in on whether you're actually listening today, or just waiting for your turn to talk.",
        spreadSuccess: "To follow through, practice being genuinely present with others again, even in small ways.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to balance your own needs with real presence for others."
    },
    {
        card: 50,
        side: "A",
        ...
        bridgeOut: "From here, the King of Cups' steadiness carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on staying emotionally steady, even while things around you shift.",
        spreadChallenge: "The challenge here is confusing calm with suppressing what you actually feel.",
        spreadAdvice: "Stay steady today, even if things around you feel chaotic. You don't have to match the storm's energy.",
        spreadSuccess: "To follow through, keep processing your feelings privately even while staying composed outwardly.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to lead with calm that comes from real emotional maturity, not suppression."
    },
    {
        card: 50,
        side: "B",
        ...
        bridgeOut: "From here, that emotional distance carries forward until it's addressed.",
        ...
        spreadFocus: "Your focus right now may be an area where composure has tipped into coldness.",
        spreadChallenge: "The challenge here is staying composed at the cost of genuine connection.",
        spreadAdvice: "Let yourself actually feel whatever you've been pushing down instead of staying composed out of habit.",
        spreadSuccess: "To follow through, allow yourself to express what you're feeling instead of just managing it internally.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to let real feeling coexist with your natural calm."
    },
        ...
        // Swords
    {
        ...
        bridgeOut: "From here, the Ace of Swords' clarity carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on speaking or acting on a truth that's become clear.",
        spreadChallenge: "The challenge here is hesitating to say the clear thing out loud.",
        spreadAdvice: "Say the clear thing you've been dancing around. The clarity you have deserves to be spoken.",
        spreadSuccess: "To follow through, keep communicating with the same directness that got you this clarity.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to act from clarity rather than retreating into ambiguity."
    },
    {
        card: 51,
        side: "B",
        ...
        bridgeOut: "From here, that mental fog carries forward until clarity returns.",
        ...
        spreadFocus: "Your focus right now may be an area where your thinking feels foggy or unfocused.",
        spreadChallenge: "The challenge here is trusting a conclusion reached while your head wasn't fully clear.",
        spreadAdvice: "Don't trust the first conclusion you land on today. Give it a second look once your head clears.",
        spreadSuccess: "To follow through, wait for a clearer moment before finalizing any big decision.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to check your thinking rather than rushing to conclusions."
    },
    {
        card: 52,
        side: "A",
        ...
        bridgeOut: "From here, the Two of Swords' held decision carries forward until it's made.",
        ...
        spreadFocus: "Your focus right now is on a decision you've been holding at arm's length.",
        spreadChallenge: "The challenge here is avoiding what you already sense beneath the blindfold.",
        spreadAdvice: "Take the blindfold off today. You know more about this decision than you're letting yourself admit.",
        spreadSuccess: "To follow through, act on what you already know instead of waiting for outside certainty.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to trust your own read on the situation."
    },
    {
        card: 52,
        side: "B",
        ...
        bridgeOut: "From here, that surfacing truth carries forward until it's fully faced.",
        ...
        spreadFocus: "Your focus right now may be an area where something hidden is starting to come to light.",
        spreadChallenge: "The challenge here is continuing to avoid what's already becoming impossible to ignore.",
        spreadAdvice: "Something you've been avoiding is about to become impossible to ignore. Better to face it on your terms.",
        spreadSuccess: "To follow through, address it directly before it's forced into the open on someone else's terms.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to face things early rather than waiting for them to surface."
    },
    {
        card: 53,
        side: "A",
        ...
        bridgeOut: "From here, the Three of Swords' honest pain carries forward as healing begins.",
        ...
        spreadFocus: "Your focus right now is on acknowledging real heartbreak instead of pushing past it.",
        spreadChallenge: "The challenge here is rushing to feel okay before you've actually processed the pain.",
        spreadAdvice: "Let yourself feel this fully instead of rushing to move past it. The grief deserves acknowledgment.",
        spreadSuccess: "To follow through, give the pain the time it needs rather than pretending it's resolved.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to process honestly rather than performing recovery."
    },
    {
        card: 53,
        side: "B",
        ...
        bridgeOut: "From here, that early healing carries forward, even if it isn't linear.",
        ...
        spreadFocus: "Your focus right now is on recognizing the healing that's already begun.",
        spreadChallenge: "The challenge here is expecting the healing to feel complete before it actually is.",
        spreadAdvice: "Give yourself credit for how far you've come, even if it doesn't feel finished yet.",
        spreadSuccess: "To follow through, keep tending to the healing gently instead of demanding it move faster.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to allow healing to unfold at its own pace."
    },
    {
        card: 54,
        side: "A",
        ...
        bridgeOut: "From here, the Four of Swords' call to rest carries forward until it's honored.",
        ...
        spreadFocus: "Your focus right now is on giving yourself real, uninterrupted rest.",
        spreadChallenge: "The challenge here is feeling guilty for stopping when there's still more to do.",
        spreadAdvice: "Cancel the thing you don't have energy for today. Rest isn't optional right now.",
        spreadSuccess: "To follow through, protect the rest fully instead of treating it as optional or negotiable.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to prioritize recovery as part of the work, not a break from it."
    },
    {
        card: 54,
        side: "B",
        ...
        bridgeOut: "From here, that resisted rest carries forward until exhaustion forces the issue.",
        ...
        spreadFocus: "Your focus right now may be an area where you're pushing through exhaustion instead of resting.",
        spreadChallenge: "The challenge here is restlessness that keeps you from actually settling down.",
        spreadAdvice: "The urge to keep pushing is exactly the sign that you need to stop. Rest before you're forced to.",
        spreadSuccess: "To follow through, choose rest deliberately before burnout makes the choice for you.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to listen to your body's signals instead of overriding them."
    },
    {
        card: 55,
        side: "A",
        ...
        bridgeOut: "From here, the Five of Swords' hollow victory carries forward unless reconsidered.",
        ...
        spreadFocus: "Your focus right now is on weighing whether winning this is actually worth it.",
        spreadChallenge: "The challenge here is wanting to win even when the cost outweighs the gain.",
        spreadAdvice: "Ask yourself if winning this argument is actually worth what it'll cost the relationship.",
        spreadSuccess: "To follow through, choose the relationship over the win if the two are actually in conflict.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to weigh cost against victory before engaging."
    },
    {
        card: 55,
        side: "B",
        ...
        bridgeOut: "From here, that regret carries forward until amends are made.",
        ...
        spreadFocus: "Your focus right now may be an area where a past conflict left you feeling exposed or regretful.",
        spreadChallenge: "The challenge here is pride getting in the way of repair.",
        spreadAdvice: "If you won something at someone else's expense recently, consider reaching out to repair it.",
        spreadSuccess: "To follow through, make the repair concrete instead of just feeling bad about it privately.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to choose repair over being right."
    },
    {
        card: 56,
        side: "A",
        ...
        bridgeOut: "From here, the Six of Swords' gradual healing carries forward as the distance grows.",
        ...
        spreadFocus: "Your focus right now is on the quiet healing that comes from putting distance between you and what hurt.",
        spreadChallenge: "The challenge here is doubting your progress because the healing feels slow or incomplete.",
        spreadAdvice: "Give yourself credit for the distance you've already put between yourself and what hurt you.",
        spreadSuccess: "To follow through, keep moving forward steadily instead of measuring the whole journey at once.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to trust the process of gradual healing."
    },
    {
        card: 56,
        side: "B",
        ...
        bridgeOut: "From here, that unresolved anxiety carries forward until it's named.",
        ...
        spreadFocus: "Your focus right now may be an area where the transition away from something difficult isn't fully complete.",
        spreadChallenge: "The challenge here is carrying unresolved anxiety instead of addressing what's left unfinished.",
        spreadAdvice: "Name the one thing that's still unresolved from the situation you're trying to leave behind.",
        spreadSuccess: "To follow through, address that lingering piece directly instead of hoping it fades on its own.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to finish the emotional work of the transition, not just the physical distance."
    },
    {
        card: 57,
        side: "A",
        ...
        bridgeOut: "From here, the Seven of Swords' quiet strategy carries forward unless reconsidered.",
        ...
        spreadFocus: "Your focus right now is on whether the shortcut you're considering is actually the right move.",
        spreadChallenge: "The challenge here is choosing what's easy over what's honest.",
        spreadAdvice: "Consider whether the workaround you're planning is actually necessary, or just easier in the short term.",
        spreadSuccess: "To follow through, choose the more honest path even if it's slower or harder.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to weigh integrity over convenience."
    },
    {
        card: 57,
        side: "B",
        ...
        bridgeOut: "From here, that pressure to be honest carries forward until it's acted on.",
        ...
        spreadFocus: "Your focus right now may be an area where a secret has become too heavy to keep.",
        spreadChallenge: "The challenge here is the discomfort of finally telling the truth.",
        spreadAdvice: "Whatever you've been keeping quiet, it's time to say it out loud, even if it's uncomfortable.",
        spreadSuccess: "To follow through, choose the moment and say it directly instead of continuing to delay.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to choose honesty even when it's uncomfortable."
    },
    {
        card: 58,
        side: "A",
        ...
        bridgeOut: "From here, the Eight of Swords' self-imposed restriction carries forward until it's questioned.",
        ...
        spreadFocus: "Your focus right now is on realizing that some of what's trapping you is a story, not a wall.",
        spreadChallenge: "The challenge here is believing you're more stuck than you actually are.",
        spreadAdvice: "Question the story you're telling yourself about being stuck. There's more room to move than it feels like.",
        spreadSuccess: "To follow through, test the boundary you assume is fixed. It may move more than expected.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to question limiting beliefs rather than accepting them as fact."
    },
    {
        card: 58,
        side: "B",
        ...
        bridgeOut: "From here, that early freedom carries forward as long as you keep working the rope loose.",
        ...
        spreadFocus: "Your focus right now is on the first real progress toward breaking free of a limitation.",
        spreadChallenge: "The challenge here is doubting the progress because it's still incomplete.",
        spreadAdvice: "Keep chipping away at the thing you've felt stuck on. You're making more progress than it feels like.",
        spreadSuccess: "To follow through, keep taking small steps toward freedom instead of waiting for one big breakthrough.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to trust incremental progress."
    },
    {
        card: 59,
        side: "A",
        ...
        bridgeOut: "From here, the Nine of Swords' looming worry carries forward until it's addressed.",
        ...
        spreadFocus: "Your focus right now is on facing anxious thoughts instead of letting them spiral unchecked.",
        spreadChallenge: "The challenge here is letting fear feel bigger and more certain than it actually is.",
        spreadAdvice: "Whatever's keeping you up at night, write it down. It tends to shrink once it's out of your head.",
        spreadSuccess: "To follow through, separate what's actually likely from what fear is exaggerating.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to name the fear instead of letting it stay vague and overwhelming."
    },
    {
        card: 59,
        side: "B",
        ...
        bridgeOut: "From here, that surfacing relief carries forward as the anxiety continues to ease.",
        ...
        spreadFocus: "Your focus right now is on being patient with yourself as a hard mental stretch eases.",
        spreadChallenge: "The challenge here is expecting to feel fully recovered before you actually are.",
        spreadAdvice: "You're coming out of a hard mental stretch. Be patient with yourself as the anxiety settles.",
        spreadSuccess: "To follow through, give yourself grace for the lingering effects instead of rushing recovery.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to be gentle with yourself through the tail end of the recovery."
    },
    {
        card: 60,
        side: "A",
        ...
        bridgeOut: "From here, the Ten of Swords' painful ending carries forward toward the dawn already visible.",
        ...
        spreadFocus: "Your focus right now is on accepting that something has truly, fully ended.",
        spreadChallenge: "The challenge here is trying to salvage what's already over.",
        spreadAdvice: "Stop trying to salvage what's already over. The relief comes once you let it actually end.",
        spreadSuccess: "To follow through, let the ending be complete instead of holding onto fragments of it.",
        spreadMoveForward: "Moving forward, staying true to this means continuing toward the new chapter instead of looking back at the old one."
    },
    {
        card: 60,
        side: "B",
        ...
        bridgeOut: "From here, that early recovery carries forward as rebuilding continues.",
        ...
        spreadFocus: "Your focus right now is on the slow, steady work of rebuilding after a hard ending.",
        spreadChallenge: "The challenge here is measuring your recovery against how far you still have to go instead of how far you've come.",
        spreadAdvice: "Take the small step forward today, even if it's tiny. Recovery counts even when it's slow.",
        spreadSuccess: "To follow through, keep taking small forward steps and tracking them as real progress.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to rebuild steadily, without rushing the process."
    },
    {
        card: 61,
        side: "A",
        ...
        bridgeOut: "From here, the Page of Swords' curiosity carries forward into real answers.",
        ...
        spreadFocus: "Your focus right now is on asking the honest question instead of assuming you already know.",
        spreadChallenge: "The challenge here is staying silent out of fear of what the answer might be.",
        spreadAdvice: "Ask the question you've been sitting on instead of assuming you already know the answer.",
        spreadSuccess: "To follow through, keep gathering real information instead of filling in the blanks yourself.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to seek clarity through direct questions."
    },
    {
        card: 61,
        side: "B",
        ...
        bridgeOut: "From here, that miscommunication carries forward unless words are chosen more carefully.",
        ...
        spreadFocus: "Your focus right now may be an area where impulsive words could cause more harm than intended.",
        spreadChallenge: "The challenge here is reacting before thinking things through.",
        spreadAdvice: "Pause before sending that message or repeating that rumor. Words are landing harder than usual right now.",
        spreadSuccess: "To follow through, build in a deliberate pause before you speak or send anything important.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to choose words carefully rather than reactively."
    },
    {
        card: 62,
        side: "A",
        ...
        bridgeOut: "From here, the Knight of Swords' decisive charge carries forward into action.",
        ...
        spreadFocus: "Your focus right now is on acting decisively while your conviction is strong.",
        spreadChallenge: "The challenge here is letting hesitation dull the edge of your resolve.",
        spreadAdvice: "Move on this today while your conviction is strong. Waiting will only dull the edge.",
        spreadSuccess: "To follow through, keep acting with the same speed and clarity that got you started.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to trust decisive action over prolonged deliberation."
    },
    {
        card: 62,
        side: "B",
        ...
        spreadFocus: "Your focus right now may be an area where speed has outrun good judgment.",
        spreadChallenge: "The challenge here is reacting in the heat of the moment instead of thinking things through.",
        spreadAdvice: "Whatever you're about to say in the heat of the moment, sit on it for an hour first.",
        spreadSuccess: "To follow through, build in a cooling-off period before acting on strong impulses.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to pair speed with restraint."
    },
    {
        card: 63,
        side: "A",
        ...
        bridgeOut: "From here, the Queen of Swords' honest clarity carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on seeing a situation clearly and naming it honestly.",
        spreadChallenge: "The challenge here is softening the truth to spare someone's feelings, including your own.",
        spreadAdvice: "Say the honest thing plainly today, without over-explaining or apologizing for it.",
        spreadSuccess: "To follow through, keep communicating with the same clarity and directness.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to lead with honesty even when it's uncomfortable."
    },
    {
        card: 63,
        side: "B",
        ...
        bridgeOut: "From here, that bitterness carries forward unless it's addressed.",
        ...
        spreadFocus: "Your focus right now may be an area where honesty has curdled into coldness or judgment.",
        spreadChallenge: "The challenge here is using sharpness to protect yourself instead of connecting honestly.",
        spreadAdvice: "Notice if you're being sharp with someone as a way to avoid being vulnerable with them.",
        spreadSuccess: "To follow through, soften your delivery without losing your honesty.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to check whether your directness is protecting you or pushing others away."
    },
    {
        card: 64,
        side: "A",
        ...
        bridgeOut: "From here, the King of Swords' fair authority carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on leading with reason and fairness rather than emotion.",
        spreadChallenge: "The challenge here is letting emotion cloud a decision that needs a clear head.",
        spreadAdvice: "Make the decision based on the facts today, not on who's louder or more upset.",
        spreadSuccess: "To follow through, keep grounding your decisions in the actual facts rather than the loudest voice in the room.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to lead with fairness and clear-headed reasoning."
    },
    {
        card: 64,
        side: "B",
        ...
        bridgeOut: "From here, that cold detachment carries forward unless tempered with fairness.",
        ...
        spreadFocus: "Your focus right now may be an area where logic is being used to justify something unkind.",
        spreadChallenge: "The challenge here is mistaking control for correctness.",
        spreadAdvice: "Check that the 'rational' choice you're leaning toward isn't just a convenient excuse to be harsh.",
        spreadSuccess: "To follow through, pair your reasoning with genuine fairness, not just self-interest.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to lead with both logic and compassion."
    },
        ...
        // Pentacles
    {
        ...
        bridgeOut: "From here, the Ace of Pentacles' tangible opportunity carries forward into real steps.",
        ...
        spreadFocus: "Your focus right now is on a real, practical opportunity worth building on.",
        spreadChallenge: "The challenge here is treating the opportunity as an idea instead of taking action on it.",
        spreadAdvice: "Take the practical first step today, even if it's small. This opportunity is worth building on.",
        spreadSuccess: "To follow through, keep making concrete, practical progress rather than staying in the planning stage.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to build steadily on what you've started."
    },
    {
        card: 65,
        side: "B",
        ...
        bridgeOut: "From here, that missed potential carries forward unless the approach is corrected.",
        ...
        spreadFocus: "Your focus right now may be an area where an opportunity has been mishandled or let slip.",
        spreadChallenge: "The challenge here is rushing in without a real plan.",
        spreadAdvice: "Before committing resources to this, slow down and actually plan instead of rushing in.",
        spreadSuccess: "To follow through, build a clear plan before committing further resources.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to be deliberate rather than reactive with your resources."
    },
    {
        card: 66,
        side: "A",
        ...
        bridgeOut: "From here, the Two of Pentacles' balance carries forward as more gets juggled.",
        ...
        spreadFocus: "Your focus right now is on managing multiple responsibilities without dropping any of them.",
        spreadChallenge: "The challenge here is feeling like the juggling act is unsustainable.",
        spreadAdvice: "Give yourself credit for how much you're actually managing right now, even if it feels chaotic.",
        spreadSuccess: "To follow through, keep adapting your approach as priorities shift rather than sticking rigidly to one plan.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to stay flexible instead of forcing perfect balance."
    },
    {
        card: 66,
        side: "B",
        ...
        bridgeOut: "From here, that overload carries forward unless something is set down.",
        ...
        spreadFocus: "Your focus right now may be an area where you've taken on more than is sustainable.",
        spreadChallenge: "The challenge here is trying to keep everything moving instead of letting one thing wait.",
        spreadAdvice: "Pick the one thing that can wait, and actually let it wait today.",
        spreadSuccess: "To follow through, actually delay or delegate the thing you identified instead of just noting it.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to protect your capacity by saying no when needed."
    },
    {
        card: 67,
        side: "A",
        ...
        bridgeOut: "From here, the Three of Pentacles' collaboration carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on building something well through collaboration and shared skill.",
        spreadChallenge: "The challenge here is trying to do it all yourself instead of inviting input.",
        spreadAdvice: "Ask for feedback on the thing you're building. Another set of eyes will strengthen it.",
        spreadSuccess: "To follow through, keep incorporating outside input as the work develops.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to value collaboration over going it alone."
    },
    {
        card: 67,
        side: "B",
        ...
        bridgeOut: "From here, that friction carries forward unless the standard is raised again.",
        ...
        spreadFocus: "Your focus right now may be an area where teamwork has broken down into low effort or pettiness.",
        spreadChallenge: "The challenge here is letting the group's standard drag your own down.",
        spreadAdvice: "If the team effort isn't working, it's okay to take more ownership of the outcome yourself.",
        spreadSuccess: "To follow through, keep your own standard high even if others around you aren't matching it.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to hold quality as a personal standard, not just a group expectation."
    },
    {
        card: 68,
        side: "A",
        ...
        bridgeOut: "From here, the Four of Pentacles' careful grip carries forward unless it's loosened.",
        ...
        spreadFocus: "Your focus right now is on examining whether your need for security has tipped into control.",
        spreadChallenge: "The challenge here is confusing holding tight with staying safe.",
        spreadAdvice: "Loosen your grip on one thing today, even slightly. Security doesn't require holding everything so tightly.",
        spreadSuccess: "To follow through, practice releasing control in small, low-stakes ways first.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to hold things a little more loosely."
    },
    {
        card: 68,
        side: "B",
        ...
        bridgeOut: "From here, that loss of control carries forward until you adapt to it.",
        ...
        spreadFocus: "Your focus right now may be an area where stability is shifting outside your control.",
        spreadChallenge: "The challenge here is fighting to hold onto something that's already changing.",
        spreadAdvice: "If something material or financial is shifting outside your control, focus on what you can actually influence.",
        spreadSuccess: "To follow through, redirect your energy toward what's actually within your control.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to adapt rather than resist the shift."
    },
    {
        card: 69,
        side: "A",
        ...
        bridgeOut: "From here, the Five of Pentacles' hardship carries forward until help is accepted.",
        ...
        spreadFocus: "Your focus right now is on getting through a hard stretch without doing it entirely alone.",
        spreadChallenge: "The challenge here is pride getting in the way of asking for help.",
        spreadAdvice: "Ask for the help that's actually available to you. You don't have to get through this entirely alone.",
        spreadSuccess: "To follow through, actually reach out for the support you need instead of just acknowledging it exists.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to accept support as it's offered."
    },
    {
        card: 69,
        side: "B",
        ...
        bridgeOut: "From here, that returning relief carries forward as things continue to improve.",
        ...
        spreadFocus: "Your focus right now is on trusting that things are genuinely starting to improve.",
        spreadChallenge: "The challenge here is staying guarded even as support becomes available.",
        spreadAdvice: "Accept the help or opportunity that's finally showing up. You don't have to prove you can do it alone.",
        spreadSuccess: "To follow through, keep letting the support in rather than pushing it away out of habit.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to trust that recovery is real and ongoing."
    },
    {
        card: 70,
        side: "A",
        ...
        bridgeOut: "From here, the Six of Pentacles' balanced exchange carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on generosity flowing freely in both directions.",
        spreadChallenge: "The challenge here is either over-giving or being too proud to receive.",
        spreadAdvice: "If you need help right now, ask for it. If you have extra to give, offer it without keeping score.",
        spreadSuccess: "To follow through, keep the exchange balanced rather than letting it tip too far one way.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to give and receive without keeping a tally."
    },
    {
        card: 70,
        side: "B",
        ...
        bridgeOut: "From here, that imbalance carries forward unless it's named.",
        ...
        spreadFocus: "Your focus right now may be an area where giving or receiving has become unfair.",
        spreadChallenge: "The challenge here is staying silent about an imbalance instead of addressing it.",
        spreadAdvice: "Notice if a relationship or deal has become one-sided, and speak up about it plainly.",
        spreadSuccess: "To follow through, have the direct conversation about what's fair instead of letting resentment build.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to protect fairness in your exchanges."
    },
    {
        card: 71,
        side: "A",
        ...
        bridgeOut: "From here, the Seven of Pentacles' patience carries forward as growth continues.",
        ...
        spreadFocus: "Your focus right now is on trusting the slow, steady growth of something you've invested in.",
        spreadChallenge: "The challenge here is impatience with a timeline that isn't fully in your control.",
        spreadAdvice: "Take stock of the progress you've already made instead of only measuring what's left to do.",
        spreadSuccess: "To follow through, keep tending to the work patiently instead of forcing faster results.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to trust the pace of real growth."
    },
    {
        card: 71,
        side: "B",
        ...
        bridgeOut: "From here, that anxiety carries forward until patience is restored.",
        ...
        spreadFocus: "Your focus right now may be an area where slow progress is causing real frustration.",
        spreadChallenge: "The challenge here is letting impatience undermine work that's actually still developing well.",
        spreadAdvice: "Resist the urge to force this today. Some things genuinely need more time, not more pressure.",
        spreadSuccess: "To follow through, keep nurturing the work instead of pushing for results before they're ready.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to trust the process even when it's slow."
    },
    {
        card: 72,
        side: "A",
        ...
        bridgeOut: "From here, the Eight of Pentacles' focused practice carries forward into real mastery.",
        ...
        spreadFocus: "Your focus right now is on dedicated, hands-on practice that's building real skill.",
        spreadChallenge: "The challenge here is losing focus to distraction instead of putting in the deliberate hours.",
        spreadAdvice: "Put in the focused hour today instead of the scattered effort. This is how skill actually gets built.",
        spreadSuccess: "To follow through, keep showing up consistently for the practice, even when it's repetitive.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to value steady craftsmanship over shortcuts."
    },
    {
        card: 72,
        side: "B",
        ...
        bridgeOut: "From here, that lost motivation carries forward until purpose is reconnected with.",
        ...
        spreadFocus: "Your focus right now may be an area where the work has started to feel hollow or mechanical.",
        spreadChallenge: "The challenge here is going through the motions without real investment.",
        spreadAdvice: "If the work feels hollow right now, reconnect with why you started it in the first place.",
        spreadSuccess: "To follow through, find one small part of the work that still feels meaningful and build from there.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to check that the work still serves your actual purpose."
    },
    {
        card: 73,
        side: "A",
        ...
        bridgeOut: "From here, the Nine of Pentacles' self-made abundance carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on enjoying something you built entirely on your own terms.",
        spreadChallenge: "The challenge here is waiting for outside validation before allowing yourself to enjoy it.",
        spreadAdvice: "Enjoy the results of your own effort today without waiting for someone else to validate it.",
        spreadSuccess: "To follow through, keep trusting your own judgment of your success rather than seeking outside approval.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to measure success by your own standard."
    },
    {
        card: 73,
        side: "B",
        ...
        bridgeOut: "From here, that performed success carries forward unless it's replaced with something real.",
        ...
        spreadFocus: "Your focus right now may be an area where the image of success matters more than how it actually feels.",
        spreadChallenge: "The challenge here is performing for an audience instead of checking in with yourself.",
        spreadAdvice: "Stop performing for an audience today and check in with what you actually want underneath the image.",
        spreadSuccess: "To follow through, keep choosing what's real over what looks impressive.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to build something that actually feels good, not just looks good."
    },
    {
        card: 74,
        side: "A",
        ...
        bridgeOut: "From here, the Ten of Pentacles' legacy carries forward into what's built next.",
        ...
        spreadFocus: "Your focus right now is on building something that will outlast this immediate moment.",
        spreadChallenge: "The challenge here is staying focused on long-term value instead of short-term wins.",
        spreadAdvice: "Think beyond today. Whatever you're building now is laying the groundwork for something longer-lasting.",
        spreadSuccess: "To follow through, keep making choices that serve the long-term picture, not just the immediate one.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to invest in what lasts."
    },
    {
        card: 74,
        side: "B",
        ...
        bridgeOut: "From here, that instability carries forward until the foundation is repaired.",
        ...
        spreadFocus: "Your focus right now may be an area where family or financial stability feels shaken.",
        spreadChallenge: "The challenge here is avoiding the tension instead of addressing it directly.",
        spreadAdvice: "Address the family or financial tension directly instead of letting it erode things quietly.",
        spreadSuccess: "To follow through, have the direct conversation needed to start repairing the foundation.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to prioritize long-term stability over short-term comfort."
    },
    {
        card: 75,
        side: "A",
        ...
        bridgeOut: "From here, the Page of Pentacles' eager curiosity carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on starting to learn something new and practical.",
        spreadChallenge: "The challenge here is waiting to feel fully ready before beginning.",
        spreadAdvice: "Start the course, the project, the plan. You don't need to know everything before beginning.",
        spreadSuccess: "To follow through, keep learning as you go instead of waiting for complete confidence first.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to grow through practical experience."
    },
    {
        card: 75,
        side: "B",
        ...
        bridgeOut: "From here, that distraction carries forward until focus is regained.",
        ...
        spreadFocus: "Your focus right now may be an area where a goal has lost your attention.",
        spreadChallenge: "The challenge here is letting distraction quietly replace commitment.",
        spreadAdvice: "Pick the one practical task you've been putting off and give it twenty focused minutes today.",
        spreadSuccess: "To follow through, keep returning to the task in small, manageable increments.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to reclaim your focus, one small step at a time."
    },
    {
        card: 76,
        side: "A",
        ...
        bridgeOut: "From here, the Knight of Pentacles' steady persistence carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on consistent, unglamorous effort that's quietly building something real.",
        spreadChallenge: "The challenge here is wanting faster or flashier progress than steady work provides.",
        spreadAdvice: "Keep doing the unglamorous, consistent work today. It's building something real, even if it's not exciting.",
        spreadSuccess: "To follow through, keep showing up reliably, even when there's no immediate reward.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to value consistency over speed."
    },
    {
        card: 76,
        side: "B",
        ...
        bridgeOut: "From here, that stagnation carries forward until momentum is regained.",
        ...
        spreadFocus: "Your focus right now may be an area where steady effort has slipped into complacency.",
        spreadChallenge: "The challenge here is letting things drift instead of picking back up the routine.",
        spreadAdvice: "Pick back up the routine or responsibility you've let slide. Small consistency matters more than a big push.",
        spreadSuccess: "To follow through, restart with one small consistent action rather than trying to catch up all at once.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to rebuild momentum gradually."
    },
    {
        card: 77,
        side: "A",
        ...
        bridgeOut: "From here, the Queen of Pentacles' grounded care carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on practical, grounded nurturing, of yourself and others.",
        spreadChallenge: "The challenge here is neglecting your own practical needs while tending to everyone else's.",
        spreadAdvice: "Take care of the practical thing today, and let that be its own form of self-care.",
        spreadSuccess: "To follow through, keep balancing care for others with care for your own foundation.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to nurture in ways that are sustainable, not depleting."
    },
    {
        card: 77,
        side: "B",
        ...
        bridgeOut: "From here, that conditional care carries forward unless it's examined.",
        ...
        spreadFocus: "Your focus right now may be an area where generosity has quietly become transactional.",
        spreadChallenge: "The challenge here is giving with strings attached instead of freely.",
        spreadAdvice: "Check whether you're giving care freely today, or using it to get something back.",
        spreadSuccess: "To follow through, notice when you're keeping score and choose to release it.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to give without expecting something in return."
    },
    {
        card: 78,
        side: "A",
        ...
        bridgeOut: "From here, the King of Pentacles' earned stability carries forward into what's next.",
        ...
        spreadFocus: "Your focus right now is on trusting the stability you've built through real, sustained effort.",
        spreadChallenge: "The challenge here is doubting your own track record despite the evidence.",
        spreadAdvice: "Trust your own track record today. You've built more stability than you're giving yourself credit for.",
        spreadSuccess: "To follow through, keep making decisions from that place of earned confidence.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to lead from experience, not doubt."
    },
    {
        card: 78,
        side: "B",
        ...
        bridgeOut: "From here, that rigidity carries forward unless real value is reconnected with.",
        ...
        spreadFocus: "Your focus right now may be an area where material success has started to overshadow what actually matters.",
        spreadChallenge: "The challenge here is measuring worth by numbers instead of meaning.",
        spreadAdvice: "Reconnect with why the security you're building matters, beyond the numbers themselves.",
        spreadSuccess: "To follow through, keep checking that your goals still serve something deeper than status.",
        spreadMoveForward: "Moving forward, staying true to this means continuing to build wealth that supports real values, not just appearances."
    }
];
...
const openingLinesTwo = [
    [
        ...
        "Rare stillness surrounds this pull — what you're seeing is simply what is, no distortion.",
        "The cards are in agreement. Trust what follows without second-guessing it.",
        "Nothing pulls against anything else here — this is as settled as a reading gets.",
        "The cards move in one direction, unhurried and sure.",
        "There's a kind of quiet confidence in this spread — no card is fighting to be heard.",
        "This pull came in smooth, without a single point of friction.",
        "Everything here aligns cleanly, like pieces that were always meant to fit.",
        "A calm reading, through and through — nothing here needs bracing for.",
        "The signal is clean. What you see is what's actually there.",
        "This spread settles easily, without any need to untangle conflicting threads.",
        "There's an unusual harmony across these cards — take that as a good sign.",
        "Nothing here contradicts anything else. Let that clarity carry you forward."
    ],
    [
        "This is a fairly ordinary reading — some threads to pull on, nothing alarming.",
        "A typical spread: a few things worth noting, but nothing that demands urgent attention.",
        ...
        "Nothing here is out of the ordinary — just the usual push and pull of things in motion.",
        "A grounded, everyday sort of pull. Take it as a gentle nudge rather than a warning.",
        "A balanced pull — some things moving, some things steady, nothing dramatic either way.",
        "This is the kind of reading that reflects an ordinary day: some effort, some ease.",
        "Nothing here is urgent, but it's still worth paying attention to.",
        "A middle-of-the-road spread — take what's useful and move on with your day.",
        "This reading sits comfortably in the everyday. No alarm bells, no fanfare.",
        "The cards suggest steady footing, with a few small things worth noticing along the way.",
        "Ordinary tension, ordinary movement — the kind every reading has a little of.",
        "This is a workable pull. Nothing here should slow you down for long.",
        "A moderate spread, neither calm nor charged — just life doing what it does.",
        "Take this one at face value. There's nothing hidden beneath the surface here."
    ],
    [
        "There's a noticeable pull of tension in this spread — worth slowing down and paying attention.",
        "A few of these cards are pulling against each other; approach this reading with a bit of caution.",
        ...
        "Something here is asking to be handled carefully — not a crisis, but not nothing either.",
        "There's a bit of resistance in this pull. Read on, but keep your eyes open.",
        "There's a bit of push and pull here — worth reading closely rather than skimming.",
        "This spread carries some weight. Not a warning exactly, but a nudge to pay attention.",
        "A few threads here are tangled. Take your time working through what follows.",
        "There's more friction in this pull than usual — approach it with a level head.",
        "This reading asks for a bit more care than most. Read slowly.",
        "Something in this spread is pulling in more than one direction — worth noticing.",
        "The tension here isn't loud, but it's present. Don't rush past it.",
        "A few of these cards are working against each other. Proceed thoughtfully.",
        "This pull carries some real friction — not dangerous, but not to be ignored either.",
        "There's enough tension here to warrant a slower read than usual."
    ],
    [
        "Before anything else: this is a heavy spread, and it deserves a moment of caution before we go further.",
        "This reading opens with real weight behind it — take a breath before reading on.",
        ...
        "This pull is a heavy one. What follows isn't meant to alarm you, but it does ask for your full attention.",
        "Sit with this for a moment before continuing — the cards are asking to be taken seriously.",
        "This is a spread that asks to be taken seriously — give it the attention it's asking for.",
        "There's real weight in this pull. Read what follows slowly and with care.",
        "This reading carries more tension than most — it deserves your full presence.",
        "Something heavy is present in this spread. Approach what follows gently.",
        "This pull isn't meant to frighten you, but it does ask you to slow all the way down.",
        "The cards here are heavy with meaning. Take your time before reacting to any of it.",
        "This is one of the more serious pulls you'll get — read it with patience.",
        "There's a lot of weight behind this spread. Give yourself space before responding to it.",
        "This reading carries real gravity. Don't rush through what comes next.",
        "The tension in this pull is significant — meet it with care, not alarm."
    ]
]
...
const conclusionReading = [
    "Sit with this one before you act on it — the meaning tends to deepen with a little time.",
    "Take what resonates and leave what doesn't. Not every word needs to fit perfectly.",
    "Let this settle before making any big moves. Clarity usually comes after reflection, not during it.",
    "Read this again in a few hours — you might notice something new the second time.",
    "The cards offer a perspective, not a verdict. The rest is yours to decide.",
    "Trust what stirred in you while reading this. That reaction is information too.",
    "The universe rarely shouts. If something here felt quiet but true, that's worth listening to.",
    "Every reading is a mirror as much as a message — notice what you brought to it.",
    "This is one thread of a much bigger pattern. Stay open to how it connects.",
    "Some truths take a few days to fully land. Give this one room to breathe.",
    "Well, that was a telling pull — the cards clearly had something to say today.",
    "That's a spread worth sitting with. The energy here was anything but random.",
    "That was a layered one. Worth thinking about more than once.",
    "A thoughtful spread today. The cards rarely line up quite like this by accident.",
    "Curious what else is waiting? You can always pull again for a different angle.",
    "If this raised more questions than it answered, that's what the next draw is for.",
    "Want a second perspective? Another pull might offer something this one didn't.",
    "This is just one layer. Feel free to draw again if you're looking for more.",
    "The cards have more to say whenever you're ready to hear it."
]

const newCardSegway = [
    "That's what I've got for you. What else is on your mind?",
    "Anyway, that's the spread. Anything else you'd like to explore?",
    "So there's your reading. Got another question for me?",
    "That wraps it up for now. Anything else you're curious about?",
    "Alright, that's the read. What's next?",
    "Anyways, got another question on your mind?",
    "That's the reading — anything else you're curious about?",
    "Alright, that's the gist of it. What's next on your mind?",
    "So that's what the cards had to say. Anything else you want to ask?",
    "That's the reading for now — got something else you're wondering about?",
]